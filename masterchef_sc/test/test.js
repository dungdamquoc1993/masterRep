...
describe("Masterchef Farming", function () {
  ...
  it("test case Anh Đức", async () => {
    ...
    console.log('a0 deposit: ', (await mscContract.connect(a0).getUserAmountDeposit('wjk')) / 10 ** 12, 'wjk')
    for (let i = 0; i < 999; i++) {
    ...
    console.log("")
    console.log('block number: ', tx.blockNumber, '| a1 deposit 100 wjk')
    ...
    console.log("")
    console.log('block number: ', tx.blockNumber, '| a2 deposit 50 wjk')
  ...
  // it('get user amount', async () => {
  //   await mscContract.connect(a0).deposit('wjk', parseUnits('100', 12))
  //   console.log((await mscContract.userInfoMap('wjk', a0.address)))
  // })
